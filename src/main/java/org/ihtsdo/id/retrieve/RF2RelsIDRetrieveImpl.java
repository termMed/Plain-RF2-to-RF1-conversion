...
import org.ihtsdo.conversion.utils.I_Tuple;

public class RF2RelsIDRetrieveImpl {


	private File sortedSnapshotRf1RelationshipsPrevious;
	...
	public RF2RelsIDRetrieveImpl( File sortedSnapshotRf1RelationshipsPrevious,
			FILE_TYPE fileType, String moduleId, File sortedSnapshotRf2RelationshipExported,String prevReleaseDate
			, File rf2OutputRelationships,File outputUUIDsToAssign, File outputDifferences) throws IOException {
		super();
		this.sortedSnapshotRf1RelationshipsPrevious = sortedSnapshotRf1RelationshipsPrevious;
		...
		if (fileType.equals(FILE_TYPE.RF1_RELATIONSHIP) ||fileType.equals(FILE_TYPE.RF2_RELATIONSHIP)){
			charType="900000000000011006";
			
		}else{
			charType="900000000000010007";
	...
	public void execute() throws Exception{
		...
		FileInputStream fis2 = new FileInputStream(sortedSnapshotRf1RelationshipsPrevious	);
	...
	abstract class Tuple implements I_Tuple {
		...
		public Tuple( String[] splittedLine, String line,boolean isRF2,String effTime){
			this.isRF2=isRF2;
			if (isRF2){
				...
				this.typeC2=splittedLine[2]  + "#" + splittedLine[3];
				this.group= splittedLine[6];
				this.groupId="";
				this.line=line;
			}
		 ...
		 */
		public String writeTuple(boolean rf2Format){
			return line;
		}
	...
	class TupleP extends Tuple {
		...
		public TupleP( String[] splittedLine, String line){
			super (splittedLine, line,false,prevReleaseDate);
			assigned=false;
		}
		public String writeTuple() {

			String[] splittLine=line.split("\t",-1);
			 return relId + "\t" + effTime + "\t" + status + "\t" + moduleId + "\t" + splittLine[1] + "\t" + splittLine[3] + "\t" + splittLine[6] + "\t" + splittLine[2]
				+ "\t" + charType + "\t" + "900000000000451002";
		}
	...
	class TupleE extends Tuple {
		...
		public TupleE( String[] splittedLine, String line){
			super (splittedLine, line,true,null);
		}
