...
public class I_Constants {
	...
	public static final String RELATIONSHIPS_FILE = "relationships_file";
	public static final String RULES_TABLE_FILE = "rules_table_file";
	public static final String RUN_CONFIGURATION_FILE = "runconfiguration.xml";
	public static final String NEW_RELATIONSHIP_FILE="Relationships_Output.txt";
	public static final String RELATIONSHIP_TO_ADD="relationship_file_to_add.file";

	public static final String HIERARCHY_ID = "top_hierarchy_id";
}
